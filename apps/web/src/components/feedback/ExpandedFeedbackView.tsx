                ...
                <div className="flex items-center gap-2 overflow-x-auto">
                  {feedBackStatus.map((status) => (
                    <button
                      ...
                      style={activeStatus === status.name ? {
                  ...
                  <div className="px-3 py-2.5">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <h3 className={`text-sm font-medium leading-5 ${
                        feedback._id === selectedFeedback._id ? 'text-[#101828]' : 'text-[#344054]'
                      }`}>
                        {feedback.title}
                      </h3>
              ...
              <div className="max-w-2xl mx-auto px-6 py-6">
                ...
                <div className="mb-8">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <span className="text-sm text-[#475467]">HQ-{selectedFeedback.uuid?.slice(0, 2)}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2.5 text-sm text-[#475467]">
                    ...
                    <span>Created by {selectedFeedback.createdBy} · {new Date(selectedFeedback.createdAt).toLocaleDateString()}</span>
                  </div>
                </div>
                ...
                <div className="prose prose-sm max-w-none mb-8 text-[#344054]">
                  {selectedFeedback.description ? (
                    <div className="whitespace-pre-wrap leading-relaxed">{selectedFeedback.description}</div>
                  ) : (
                    <p className="text-[#475467] italic">No description provided</p>
                  )}
                </div>
                ...
                {selectedFeedback.labels && selectedFeedback.labels.length > 0 && (
                  <div className="flex flex-wrap gap-2 mb-8">
                    {selectedFeedback.labels.map((label: any) => (
                      <span
                        key={label.id}
